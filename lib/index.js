...
function Modal(_ref) {
  ...
  var overlayDefaultStyle = {
    // Styles par défaut pour loverlay qui recouvre toute la page
    position: 'fixed',
    top: 0,
    left: 0,
    right: 0,
  ...
  var modalDefaultStyle = {
    // Styles par défaut pour la fenêtre modale
  ...
  var headerDefaultStyle = {
    // Styles par défaut pour l'en-tête de la fenêtre modale
    position: 'relative',
    display: 'flex',
  ...
  var closeButtonDefaultStyle = {
    // Styles par défaut pour le bouton de fermeture
    position: 'absolute',
    top: '5px',
    right: '5px',
  ...
  var headerStyles = _objectSpread(_objectSpread({
    // Fusion des styles par défaut et personnalisés pour l'en-tête
    color: textColor,
    backgroundColor: backgroundColor,
    fontSize: titleFontSize
  }, headerDefaultStyle), customStyles.header);
  var contentStyles = _objectSpread({
    // Fusion des styles par défaut et personnalisés pour le contenu
    color: textColor,
